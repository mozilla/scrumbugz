...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scrum_bug', (
            ...
            ('resolution', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True)),
            ...
            ('blocks', self.gf('jsonfield.fields.JSONField')(default='', blank=True)),
            ('depends_on', self.gf('jsonfield.fields.JSONField')(default='', blank=True)),
