...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bug.attachments'
        db.add_column('scrum_bug', 'attachments',
                      self.gf('scrum.models.CompressedJSONField')(default=[], blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Bug.attachments'
        db.delete.column('scrum_bug', 'attachments')
    ...
    models = {
        ...
        'scrum.bugzillaurl': {
            ...
            'date_synced': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
